...
class PostForm(FlaskForm):
    ...
    job_level = SelectField('Nível da vaga', choices=[('',''),('aprendiz','Aprendiz'),('estagio','Estágio'),('trainee', 'Trainee'),('junior','Junior'),('pleno','Pleno'),('senior','Sênior')])
    course_level = SelectField('Nível do curso', choices=[('',''),('iniciante','Iniciante'),('intermediario','Intermediário'),('avancado', 'Avançado')])
    job_mod = SelectField('Tipo da vaga', choices=[('',''),('escritorio','Escritório'),('hibrido','Híbrido'),('homeoffice', 'Home Office')])
    course_mod = SelectField('Tipo do curso', choices=[('',''),('presencial','Presencial'),('semipresencial','Semipresencial'),('ead', 'EAD')])
