...
from protPI1 import app, db, bcrypt, mail
from protPI1.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
